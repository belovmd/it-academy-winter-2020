...
def order_list(_list=None):
    """Перемещение всех ненулевых элементов списка
    в левую часть с сохранением первоначального
    порядка следования. После перемещения элементы
    списка выводятся в консоль.
