...
my_string = "Time Out выбрал 8 самых интересных сериалов осени — среди них новый проект итальянца Луки Гуаданьино, " \
            "конспирологический триллер с Джудом Лоу, сай-фай драма от Netflix, а также хоррор-комедия при участии " \
