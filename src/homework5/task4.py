...
def __map_to_property(obj, prop):
...
titles_list = __map_to_property(movies_list, 'title')
movies_titles = '\n'.join(titles_list)
...
rank_list = __map_to_property(movies_list, 'rank')
...
years_list = __map_to_property(movies_sorted_by_year, 'year')
rank_list = __map_to_property(movies_sorted_by_year, 'rank')
