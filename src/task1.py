...
def runner(func=None):
    """ Поиск имени функции в модуле, при его отсутствии - рендер всех функций, найденных в модуле

    :param func: str|None. Запрашиваемое имя функции если оно заданно, иначе None
    :return: None.
    """
    try:
        import tasks
