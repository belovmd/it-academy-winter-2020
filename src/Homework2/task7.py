...
""" Дано число n. Вывести квадрат каждого числа, предшествующего числу n, не включая квадрат n"""
...
"""Напишите программу, которая считывает строку, состояющую из целых чисел (разделены пробелом)
